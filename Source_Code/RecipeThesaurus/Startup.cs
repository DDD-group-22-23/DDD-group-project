    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthorization(options =>
                options.AddPolicy("Registered", policy => policy.RequireClaim("aud", Configuration["RecipeThesaurusApp:ClientId"]))
            );
            services.AddAuthorization(options =>
            ...
            services.AddAuthentication(options =>
            {
                ...
                .AddOpenIdConnect("oidc", options =>
                {
                    ...
                    options.Authority = Configuration["RecipeThesaurusApp:Authority"];
                    ...
                    options.TokenValidationParameters = new TokenValidationParameters
                    {
                        ...
                        ValidAudience = Configuration["RecipeThesaurusApp:ClientId"]
                    };
                });
